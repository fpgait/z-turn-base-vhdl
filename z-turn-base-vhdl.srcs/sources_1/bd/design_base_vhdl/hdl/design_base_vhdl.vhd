...
entity design_base_vhdl is
  ...
  attribute CORE_GENERATION_INFO of design_base_vhdl : entity is "design_base_vhdl,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_base_vhdl,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_base_vhdl : entity is "design_base_vhdl.hwdef";
end design_base_vhdl;

architecture STRUCTURE of design_base_vhdl is
  component design_base_vhdl_processing_system7_0_0 is
  port (
  ...
  end component design_base_vhdl_processing_system7_0_0;
  component design_base_vhdl_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component design_base_vhdl_util_vector_logic_0_0;
  component design_base_vhdl_util_vector_logic_1_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component design_base_vhdl_util_vector_logic_1_0;
  component design_base_vhdl_util_vector_logic_2_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component design_base_vhdl_util_vector_logic_2_0;
  component design_base_vhdl_xlconcat_0_0 is
  port (
  ...
  end component design_base_vhdl_xlconcat_0_0;
  signal Op1_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal Op1_2 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal Op1_3 : STD_LOGIC_VECTOR ( 0 to 0 );
...
begin
  FCLK_CLK1_50M <= processing_system7_0_FCLK_CLK1;
  ...
  hdmi_data(14) <= 'Z';
  hdmi_data(15) <= 'Z';
processing_system7_0: component design_base_vhdl_processing_system7_0_0
     port map (
...
util_vector_logic_0: component design_base_vhdl_util_vector_logic_0_0
     port map (
      Op1(0) => Op1_1(0),
      Res(0) => util_vector_logic_0_Res(0)
    );
util_vector_logic_1: component design_base_vhdl_util_vector_logic_1_0
     port map (
      Op1(0) => Op1_2(0),
      Res(0) => util_vector_logic_1_Res(0)
    );
util_vector_logic_2: component design_base_vhdl_util_vector_logic_2_0
     port map (
      Op1(0) => Op1_3(0),
      Res(0) => util_vector_logic_2_Res(0)
    );
xlconcat_0: component design_base_vhdl_xlconcat_0_0
     port map (
      In0(0) => util_vector_logic_0_Res(0),
      In1(0) => '0',
      In2(0) => util_vector_logic_1_Res(0),
      In3(0) => util_vector_logic_2_Res(0),
